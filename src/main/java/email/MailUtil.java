...
public class MailUtil {
	public static void sendMailUsingTLS(String host,
      ...
      public static void main(String[] args) {
         ...
         String username = "anithanambi2000@gmail.com";
         String password = "xmufxrxnphkndgch"; //app password
         String fromAddress = "anithanambi2000@gmail.com";
         String toAddress = "ganeshsriram22@gmail.com";
